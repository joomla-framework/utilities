...
/**
 * Abstract Format for loader
 *
 * @since  2.0
 */
abstract class AbstractLoaderFormat
{
	/**
	 ...
	 *
	 * @return  AbstractLoaderFormat  Registry format handler
	 *
	 * @since   2.0
	...
	public static function getInstance($type)
	{
		...
		{
			$class = '\\Joomla\\Utilities\\Format\\' . ucfirst($type);
